        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div data-aos="fade-right">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <FaMapMarkerAlt className="text-blue-600 mt-1 h-6 w-6" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <FaPhone className="text-blue-600 mt-1 h-6 w-6" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <FaEnvelope className="text-blue-600 mt-1 h-6 w-6" />
                <div>
            ...
            <div className="mt-8 rounded-lg overflow-hidden shadow-lg">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.993701816586!2d81.33999800907087!3d6.891355693078959!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae450822efad3d5%3A0xc77ffeaef05c031c!2sDistrict%20General%20Hospital%20Monaragala!5e0!3m2!1sen!2slk!4v1752570537256!5m2!1sen!2slk" 
                width="100%" 
                height="350" 
                style={{ border: 0 }} 
          ...
          <div data-aos="fade-left">
            ...
            <form className="space-y-6 bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div>
                <Button variant="primary" className="w-full">පණිවිඩය යවන්න</Button>
              </div>
            </form>
          </div>
